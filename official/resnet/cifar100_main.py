...
# Running the model
###############################################################################
class Cifar100Model(resnet_model.Model):
...
def define_cifar_flags():
  ...
  flags_core.set_defaults(data_dir='./cifar-100-binary',
...
def run_cifar(flags_obj):
  ...
  resnet_run_loop.resnet_main(
      flags_obj, cifar100_model_fn, input_function, DATASET_NAME,
